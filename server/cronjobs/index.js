...
async function main(){
    ...
    if( getDayOfWeek()!=='Sunday' && getDayOfWeek()!=='Saturday' && getTimeOfDay()===22 && getDayOfMonth()===1 ){
        await monthlyZones();
        await weeklyZones();
    }
    
    //if the first falls on a weekend, find the monthly zones at the following Sunday at 5pm
    else if( getDayOfWeek()==='Sunday' && (getDayOfMonth()===1 || getDayOfMonth()===2) && getTimeOfDay()===22){
    ...
    else if( getDayOfWeek()==='Sunday' && getTimeOfDay()===22 ){
